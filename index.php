<?php
    ...
    $sql_query = $mysqli->query("SELECT * FROM usuarios WHERE id = '$usuario_id'") or die($mysqli->error);
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="header-notification">
                                <a href="#!">
                                    <i class="ti-money"></i>
                                    <span class="badge bg-c-pink"></span><?php echo $usuario['creditos'];?>
                                </a>
                            </li>
                            <?php  }?>
                ...
                <div class="pcoded-wrapper">
                    ...
                    <?php if(!isset($_SESSION['admin']) || !$_SESSION['admin']) { ?>
                        <div class="sidebar_toggle"><a href="#"><i class="icon-close icons"></i></a></div>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="index.php">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Pgina Inicial</span>
                            ...
                            <?php }else{  ?>
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.navigation">Menu Admnistrador</div>
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    <a href="index.php?p=relatorio">
                                        ...
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Relátorio</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
