...
if (isset($_POST['email']) || isset($_POST['senha'])) {
    ...
    $senha = $mysqli->escape_string(md5($_POST['senha']));
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material" method="POST">
                            <div class="text-center">
                                <img height ='60' src="assets/images/auth/logo.png" alt="logo.png">
                            </div>
                            <div class="auth-box">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" name="enviar"class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Entrar</button>
                                    </div>
                                </div>
                                <hr/>
