      ...
      if(count($erro) == 0) {
        ...
        if(isset($_FILES['imagem']) && isset($_FILES['imagem']['size']) && $_FILES['imagem']['size'] > 0){
          ...
          if($deu_certo !== false) {
            ...
            if($imagemAlterada){
                $sql_code = "UPDATE cursos SET titulo='$titulo', descricao_curta='$descricao_curta', conteudo='$conteudo', preco='$preco', imagem='$deu_certo' WHERE id = $id LIMIT 1";

            }else{

                $sql_code = "UPDATE cursos SET titulo='$titulo', descricao_curta='$descricao_curta', conteudo='$conteudo', preco='$preco'  WHERE id = $id LIMIT 1";
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="titulo"  value="<?php echo $curso['titulo']; ?>" class="form-control">
                                </div>  
                            </div>
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <label for="">Descrição Curta</label>
                                    <input type="text" name="descricao_curta" value="<?php echo $curso['descricao_curta']; ?>" class="form-control">
                                </div>  
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="preco" value="<?php echo $curso['preco']; ?>"class="form-control">
                                </div>  
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
